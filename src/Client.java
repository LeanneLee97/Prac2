...
public class Client {
    ...
    public static void main(String[] args) throws CustomException {
        ...
        String[] inputs = {
                ...
                "add Hanna Moon __Hi.@potatoesarelife.com",
                "add Adam Moon .hihi@potatoesarelife.com",
                "add Adam Boon -hi__@teaforlife.com",
                "add Adam Boon hihi--hihi@teaforlife.com",
                "add Adam Boon green-tea@teaforlife.com",
                "list",
                "update 3 Adam",
                "list",
                "undo",
